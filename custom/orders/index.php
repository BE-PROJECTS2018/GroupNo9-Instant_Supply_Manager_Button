        ...
        <div class="row">
            ...
            <div class="col-md-3">
                ...
                <div class="list-group">
                    ...
                    <a href="../cart.php" class="list-group-item">BACK TO CART</a>
 ...
 while($arr=mysql_fetch_array($seli))
{
  ...
  <tr><td><font face='Lucida Sans Unicode' size='+1'>
  <b>Total Items : </b>&nbsp;".$data['count(item)']."
  <br><b>Total Cost : </b>Rs. ".$_REQUEST['tot']."
  </font></td></tr></table></fieldset></center><hr>";
}
 ?>

 <div  class="form">
   <form id="orderform" name="orderform" method="post" action="invoice.php">
